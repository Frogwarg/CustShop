...
//builder.WebHost.UseUrls("http://0.0.0.0:5123", "https://0.0.0.0:7036", "http://localhost:5123", "https://localhost:7036"); //комментируем чтобы деплоить, раскоменнтируем чтобы разрабатывать
